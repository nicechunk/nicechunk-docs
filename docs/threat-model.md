...
This document describes the security boundaries that public reviewers and maintainers should use when reviewing NiceChunk. It is intentionally scoped to the public repository surfaces and does not publish private deployment details.
