...
| Release and audit | `docs/evaluator-dossier.md`, `docs/public-review-guide.md`, `docs/release-readiness.md`, `docs/repository-maturity-scorecard.md`, `docs/split-publication-status.md`, `docs/browser-smoke-audit.md`, `docs/wallet-flow-audit.md`, `docs/fourier-pickaxe-showcase.md`, `docs/guardian-load-audit.md`, `docs/threat-model.md`, `docs/validation-matrix.md`, `docs/ci-workflow-spec.md`, `scripts/audit-evaluator-dossier.mjs`, `scripts/audit-repository-health.mjs`, `scripts/audit-repository-maturity.mjs`, `scripts/audit-browser-smoke.mjs`, `scripts/audit-wallet-flows.mjs`, `scripts/audit-fourier-pickaxe-docs.mjs`, `scripts/audit-split-remotes.mjs`, `scripts/split-github-repos.mjs`, `scripts/validate-split-repos.mjs`, `scripts/collect-release-evidence.mjs` | Evidence quality, evaluator handoff, browser smoke coverage, wallet flow coverage, Fourier Pickaxe documentation coverage, Guardian load coverage, maturity scoring, split safety and publication status, release gates, provenance, rollback, and secret exposure controls. |
...
| Fourier Pickaxe | `fourier-pickaxe/`, `docs/fourier-pickaxe-showcase.md`, `scripts/audit-fourier-pickaxe-docs.mjs` | GPU requirement clarity, voxel function payload review, documentation-first evidence, and public security boundary. |
