...
| Release and audit | `docs/public-review-guide.md`, `docs/release-readiness.md`, `docs/repository-maturity-scorecard.md`, `docs/browser-smoke-audit.md`, `docs/guardian-load-audit.md`, `docs/threat-model.md`, `docs/validation-matrix.md`, `docs/ci-workflow-spec.md`, `scripts/audit-repository-health.mjs`, `scripts/audit-repository-maturity.mjs`, `scripts/audit-browser-smoke.mjs`, `scripts/split-github-repos.mjs`, `scripts/validate-split-repos.mjs`, `scripts/collect-release-evidence.mjs` | Evidence quality, browser smoke coverage, Guardian load coverage, maturity scoring, split safety, release gates, provenance, rollback, and secret exposure controls. |
