...
| Release and audit | `docs/public-review-guide.md`, `docs/release-readiness.md`, `docs/repository-maturity-scorecard.md`, `docs/browser-smoke-audit.md`, `docs/wallet-flow-audit.md`, `docs/fourier-pickaxe-showcase.md`, `docs/guardian-load-audit.md`, `docs/threat-model.md`, `docs/validation-matrix.md`, `docs/ci-workflow-spec.md`, `scripts/audit-repository-health.mjs`, `scripts/audit-repository-maturity.mjs`, `scripts/audit-browser-smoke.mjs`, `scripts/audit-wallet-flows.mjs`, `scripts/audit-fourier-pickaxe-docs.mjs`, `scripts/split-github-repos.mjs`, `scripts/validate-split-repos.mjs`, `scripts/collect-release-evidence.mjs` | Evidence quality, browser smoke coverage, wallet flow coverage, Fourier Pickaxe documentation coverage, Guardian load coverage, maturity scoring, split safety, release gates, provenance, rollback, and secret exposure controls. |
