...
1. player_profile writable PDA ["player-v7", payer]
...
Accounts:
0. authority      signer
1. player_profile writable PDA ["player-v7", authority]
2. global_config  readonly
```
...
Accounts:
0. authority      writable signer
1. player_profile readonly PDA ["player-v7", authority]
