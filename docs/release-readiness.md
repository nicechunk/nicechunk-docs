...
| Review readiness acceptance | Final local accept-or-hold gate combines maturity, release evidence, review package, split policy, clean worktrees, and allowed external blockers | `npm run audit:review-readiness`, `docs/review-readiness-acceptance.md` |
