...
This document explains how NiceChunk handles dependency risk, lockfiles, and audit findings. It is written for maintainers and external reviewers that need reproducible supply-chain evidence.
