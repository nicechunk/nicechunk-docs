...
The manifest gives reviewers a deterministic inventory of public media, character references, wallet icons, NCM samples, and visual references. It exists so asset review does not depend on filename memory or informal screenshots.
