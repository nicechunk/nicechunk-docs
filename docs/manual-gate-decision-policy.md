...
- Accept `review-ready` only when deferred gates are named in `docs/manual-release-gates.md`, `docs/publication-blockers.md`, release evidence, and maturity output.
