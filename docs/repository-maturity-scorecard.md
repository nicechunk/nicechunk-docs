...
This scorecard gives external reviewers a compact, evidence-based view of the NiceChunk repository set.
...
| Review documentation | 10 | README, contribution/support/community files, CODEOWNERS, PR template, ownership, architecture, validation, browser/wallet/Fourier/Guardian evidence docs, and this scorecard. |
...
- External blocker evidence is tracked in `docs/external-blocker-evidence.md` and audited with `npm run audit:external-blockers`.
