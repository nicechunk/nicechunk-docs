...
Fourier Voxel needs GPU/WebGL hardware for runtime proof. This packet is the display material to use when the current reviewer or CI environment cannot run the page meaningfully.
